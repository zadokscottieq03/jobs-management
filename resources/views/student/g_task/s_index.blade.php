                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="20%" style="text-align: center;">
                                    ...
                                    <a href="{{ Asset($link.$g_task->id.'/send-proof') }}" class="btn purple tooltipped " data-position="top" data-delay="50" data-tooltip="Attach Completion Proof" style="padding:0px 10px"><i class="fa fa-paperclip"></i></a>
