...
@section('title') Task for {{ $teacher->name }} @endsection
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        {!! Form::model($data, ['url' => [env('admin').'/teacher/'.$teacher->id.'/add_task'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
                        <h4 class="header2">Manage Task for {{ $teacher->name }} Here</h4>
