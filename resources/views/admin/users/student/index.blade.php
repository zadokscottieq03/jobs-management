                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <form action="{{ Asset(env('student').'/loginWithID/'.$student->id) }}" method="POST" target="_blank" class="form-inline">
                                        @csrf
                                        <button type="submit" class="btn purple tooltipped " data-position="top" data-delay="50" data-tooltip="Login as {{ $student->name }}" style="padding:0px 10px"><i class="fa fa-sign-in"></i></button>
                                    </form>
