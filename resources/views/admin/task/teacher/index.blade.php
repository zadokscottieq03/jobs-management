...
@section('title') Manage Teacher Tasks @endsection
                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15%">{{ $teacher->find($task->asg_teacher_id)->name }}</td>
                                ...
                                <td width="20%" style="text-align: center;">
                                    ...
                                    <a href="{{ Asset($link.$task->id.'/extend') }}" class="btn purple tooltipped " data-position="top" data-delay="50" data-tooltip="Extend This Entry" style="padding:0px 10px"><i class="fa fa-expand"></i></a>
