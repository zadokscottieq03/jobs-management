...
@section('title') Teacher Task Trash @endsection
...
<div class="container">
    ...
    <div class="section">
       ...
       <a href="{{ Asset($link.'add') }}" class="btn purple waves-effect waves-light right" style="margin-top:25px">Add New</a>
        ...
        <a href="{{ Asset($link) }}" class="btn purple waves-effect waves-light right" style="margin-top:25px;margin-right:5px;">Back</a>
                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="20%">{{ $teacher->find($task->asg_teacher_id)->name }}</td>
