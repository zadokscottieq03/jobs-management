...
@section('title') Search Task Requests @endsection
...
<div class="container">
    ...
    <div class="section">
        ...
        <a href="{{ Asset($link) }}" class="btn purple waves-effect waves-light right" style="margin-top:25px">Display All </a>
        ...
        <div class="col s12 m12 l12">
         ...
         {!! Form::model($data, ['method' => 'GET','url' => [env('admin').'/task-requests/search'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
