        ...
        <form class="login-form" action="{{ Asset(env('admin').'/login') }}" method="post" autocomplete="off">
          ...
          <div class="row">
            <div class="input-field col s12 center">
              <img src="{{ Asset('images/logo.png') }}" alt="" class="responsive-img valign">
          ...
          <div class="row">
            <div class="input-field col s12">
              <button type="submit" class="btn waves-effect waves-light purple col s12">
                Login
              </button>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12 m12 l12">
              <p class="margin medium-small"><a href="{{ Asset(env('teacher').'/login') }}">Login in Teacher Panel</a></p>
            </div>
